...
<<<<<<< Upstream, based on branch 'master' of https://github.com/Chouch0/Nytro
						<div class = "elementoTendina">
							<a href="/NYTRO/ListaCaseEditrici">Case Editrici</a>
=======
				<%} else { %>
...
>>>>>>> 9bb9620 Inizio a lavorare - organizzazione logica migliore dei vari elementi della pagina
						</div>
					</div>
				<%} %>
			</li>
