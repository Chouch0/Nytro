...
public class LogFilter implements Filter {
	...
	private final String[] noRuolo = {"Index","Login","LoginForm","RecuperaPassword","RegistrazioneForm","RegistrazioneUtente","VerificaUsername","contatti.jsp", "error.jsp", "index.jsp", "loginForm.jsp", "registrazioneForm.jsp", "image"};
	private final String[] adminRuolo = {"Index","AggiornaProfilo","Catalogo","CatalogoCasaEditrice","ListaCaseEditrici","RegistrazioneCasaEditrice", "RimozioneAccount","ListaGiocatori","Logout","Profilo","VerificaUsername","Videogioco","contatti.jsp", "error.jsp", "index.jsp","profilo.jsp", "listaCadeEditrici.jsp", "listaGiocatori.jsp", "registrazioneCasaEditrice.jsp", "rimozioneAccount.jsp","videogioco.jsp", "image"};
	private final String[] giocatoreRuolo = {"Index","AggiornaProfilo","AggiungiFriend","Catalogo","CatalogoCasaEditrice","Friendlist","GestoreCarrello","Libreria","ListaCaseEditrici","Logout","Profilo","RimuoviFriend","VerificaUsername","Videogioco","contatti.jsp", "error.jsp", "index.jsp","profilo.jsp", "carrello.jsp", "catalogo.jsp", "catalogoCasaEditrice.jsp", "friendlist.jsp", "libreria.jsp", "listaCadeEditrici.jsp", "videogioco.jsp", "image"};
	private final String[] aziendaRuolo = {"Index","AggiornaProfilo","Logout","Profilo","Pubblicazioni","VerificaUsername","Videogioco","contatti.jsp", "error.jsp", "index.jsp", "profilo.jsp", "catalogoCasaEditrice.jsp", "pubblicazioni.jsp", "videogioco.jsp", "image"};
