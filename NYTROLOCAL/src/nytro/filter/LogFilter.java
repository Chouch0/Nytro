...
public class LogFilter implements Filter {
	...
	private final String[] noRuolo = {"Ricerca","RicercaAjax","ricerca.jsp","Index","Login","LoginForm","RecuperaPassword","RegistrazioneForm","RegistrazioneUtente","VerificaUsername","contatti.jsp", "error.jsp", "VerificaIsin", "index.jsp", "loginForm.jsp", "registrazioneForm.jsp", "image"};
